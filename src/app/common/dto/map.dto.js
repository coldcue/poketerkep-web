...
function MapDTO(ENV, StorageService, IntervalService, $window, $log, uiGmapIsReady, Utils, Analytics) {
    ...
    _this.init = function (getGameData) {
        var centerCoords = StorageService.get('playerPosition') || ENV.mapDefaults.center;
        ...
        _this.map = {
            ...
            tiles: {
                url: 'https://api.mapbox.com/styles/v1/{mapId}/tiles/256/{z}/{x}/{y}@2x?access_token={apiKey}',
                options: {
                    apiKey: ENV.mapbox.apiKey,
